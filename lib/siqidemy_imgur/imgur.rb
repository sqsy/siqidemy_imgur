...
# /!\ WARNING /!\
# This plugin has been extracted from the Siqidemy source code and has not been tested.
...
module Imgur
  ...
  def self.store_file(file, image_info, upload_id)
    raise Siqidemy::SiteSettingMissing.new("imgur_endpoint")   if SiteSetting.imgur_endpoint.blank?
    raise Siqidemy::SiteSettingMissing.new("imgur_client_id")  if SiteSetting.imgur_client_id.blank?
